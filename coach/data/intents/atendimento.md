...
## intent:depressao_teste
- teste para depressao
- teste de depressao
- quero fazer um teste de depressao
- questionario Wakefield
- questionario para depressao
...
## intent:depressao_idoso
- pessoas idosas tem mais depressao
- depressao em pessoas idosas
- a depressao piora com a idade
- pessoas velhas com depressao
- idosos tem mais depressao
- a depressao piora com a idade
- os idosos tem mais risco de depressao
- idosos sofrem mais com depressao
...
## intent:depressao_status_melhora
...
- por equanto é só isso
- por equanto era isso
- por equanto é só
